            ...
            <div className="row row-cols-1 row-cols-md-3 g-4">
              <div className="col">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    <h3 className="card-title">Analyse et définition du projet</h3>
                    <p className="card-text">
                    Étude de faisabilité du projet entrepreneurial.<br></br>
                    Analyse des besoins financiers, matériels, et humains.<br></br>
                    Identification des opportunités de marché et des risques.
                    </p>                    
                  </div>
              ...
              <div className="col">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    <h3 className="card-title">Élaboration d’un business plan</h3>
                    <p className="card-text">
                    Définition des objectifs stratégiques et financiers.<br></br>
                    Prévisions financières (chiffre d’affaires, charges, bénéfices).<br></br>
                    Présentation du projet aux investisseurs ou institutions financières.
                    </p>                    
                  </div>                  
                 </div>
              </div>  
