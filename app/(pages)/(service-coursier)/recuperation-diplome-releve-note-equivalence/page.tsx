                      ...
                      <div className="col-sm-12 col-lg-6 py-5 ps-lg-5 axel-block1">
                        ...
                        <div className="col-sm-12 col-lg-6 p-auto pe-lg-5">
                            <div className="d-flex flex-column mb-3">
                                <h3 className="axel-text-orange fs-3 fw-bolder"><Link href="/" className="text-white">Accueil</Link> >>> <span>Récupération diplôme, relevé de note, équivalence</span></h3>                            
                                <h1 className="text-white fw-bolder pt-3">Récupération diplôme, relevé de note, équivalence,...</h1>
