                      ...
                      <div className="col-sm-12 col-lg-6 py-5 ps-lg-5 axel-block1">
                        ...
                        <div className="col-sm-12 col-lg-6 p-auto pe-lg-5">
                            <div className="d-flex flex-column mb-3">
                                <h3 className="axel-text-orange fs-3 fw-bolder"><Link href="/" className="text-white">Accueil</Link> >>> <span>Création d'un SARL / SARLU</span></h3>                            
                                <h1 className="text-white fw-bolder pt-3">Création d'un SARL / SARLU</h1>
          ...
          <div className='container py-5'>
            <div className="row d-flex justify-content-center py-5">
                ...
                <div className="col col-lg-8 d-flex  flex-column justify-content-center align-items-center">
                    ...
                    <h2 className="text-white fs-2 fw-bolder text-center">Création d'un SARL / SARLU</h2>
                    <div className="border border-info border-2 w-25 my-3"></div>
