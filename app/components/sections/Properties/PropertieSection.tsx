            ...
            <div className="container py-5">
                    <div className="row justify-content-around px-3">                        
                        <div className="col-sm-12 col-lg-6 p-auto pe-lg-5">
                            ...
                            <div className={`${styles.axelBox} ${styles.border} row axel-box border border-1 rounded align-items-start my-3 py-3 px-2`}>
                                ...
                                <div className="axel-box-content col-sm-12 col-lg-9">
                                    <h5 className='f-bold fs-3 axel-text-blue'>Tarif avantageux et sans déplacement</h5>
                            ...
                            <div className={`${styles.axelBox} ${styles.border} row axel-box border border-1 rounded align-items-start my-3 py-3 px-2`}>
                                ...
                                <div className="axel-box-content col-sm-12 col-lg-9 ">
                                    <h5 className='f-bold fs-3 axel-text-blue'>Rapidité de service</h5>
                            ...
                            <div className={`${styles.axelBox} ${styles.border} row axel-box border border-1 rounded align-items-start my-3 py-3 px-2`}>
                                ...
                                <div className="axel-box-content col-sm-12 col-lg-9">
                                    <h5 className='f-bold fs-3 axel-text-blue'>Fiabilité et confidentialité</h5>
                        ...
                        <div className="col-sm-12 col-lg-6 pt-5 pt-lg-0 ps-lg-5 axel-block1">
                                ...
                                <div className={`${css.blockEffect} axel-block2`}></div>                       
                        </div>                         
